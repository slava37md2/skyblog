...
function SmilesTable()
{
	if(ie)
	{
		...
		{
		document.all.SmilesText.innerText="Не добавлять статью";
		document.all.SmilesTr.style.display='';
		}

		else
		{
		document.all.SmilesText.innerText="Добавить статью";
	...
	else if(ns)
	{
		...
		{
		document.getElementById("SmilesText").innerHTML="Не добавлять статью";
		document.getElementById("SmilesTr").style.display='';
		}

		else
		{
		document.getElementById("SmilesText").innerHTML="Добавить статью";
